...
directory = r'C:\Users\mbriatte\Desktop\02 - Modelisation_et_caracterisations\Dilatation thermique/' 
fichier = 'MA4_L1440_D525.txt'

df = pd.read_csv(directory + fichier, sep=';',skiprows=range(26), skipfooter=1)
df2 = pd.read_csv(directory + fichier, sep=';',skiprows=range(1),skipfooter=len(df)+5)
...
plt.title('Evolution de la température et de la variation de longueur en fonction du temps')
